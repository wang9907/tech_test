...
import com.summer.tech.mybatis.entity.Teacher;
import com.summer.tech.mybatis.entity.User;
...
public interface UserMapper {
    ...
    @Results(id="baseResult",value = {@Result(id=true,property = "id",column = "id"),
            ...
            //一对一
            //@Result(property = "account",column = "id",one = @One(select = "AccountMapper.selectByPrimaryKey",fetchType = FetchType.EAGER))
            // 一对多
            @Result(property = "accounts" ,column = "id",many = @Many(select = "AccountMapper.findAccountByUid"))
            })
    List<User> findAll();
