package com.summer.tech.springmvc.utils;
...
public class PhoneNumberFormatter implements Formatter<PhoneNumberModel> {
	...
	public String print(PhoneNumberModel phoneNumber, Locale locale) {// ①格式化
		...
		return new StringBuilder().append(phoneNumber.getAreaCode())
				.append("-").append(phoneNumber.getPhoneNumber()).toString();
	}

	@Override
	public PhoneNumberModel parse(String text, Locale locale)
