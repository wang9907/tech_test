...
public class OptionalUsage {
	...
	public static void main(String[] args) {
		 ...
		 *
		 * objectOptional.orElseThrow(() -> new
		 * RuntimeException("Not have reference"));
		 */
		/*
		 * Insurance insurance = insuranceOptional1.filter(i -> i.getName() !=
		 * null).get(); System.out.println(insurance);
		 */

		/*
		 * Optional<String> nameOptional = insuranceOptional1.map(i ->
		 * i.getName());
		 *
